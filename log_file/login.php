...
if(isset($_POST['submit'])){
   ...
   $select = mysqli_query($conn, "SELECT * FROM `users` WHERE email = '$email' AND password = '$pass'") or die(include'error.php');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>У вас нету аккунта? <a href="register.php">Регистрация</a></p>
   </form>
