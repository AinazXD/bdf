...
<head>
  ...
  <script src="/profil_file/js/prof.js"></script>
</head>
  ...
  <body>
        ...
        <div class="circle">
          <div class="dropdown">
            ...
            <div class="dropdown-options">
              <a href="settings_profil/setting_profil.php">Настройки</a>
    ...
    <div class="main">
        ...
        <div class="center" id="center">
          <div href="log_file/login.html" class="btn">
            <a href="../chat/chat.html">Начать чат</a>
          </div>
        </div>
        <div class="social">
        </div>
