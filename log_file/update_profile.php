...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `users` SET name = '$update_name', email = '$update_email' WHERE user_id = '$user_id'") or die('query failed');
...
<div class="update-profile">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="обновить данные" name="update_profile" class="btn">
